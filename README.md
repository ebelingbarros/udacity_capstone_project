...
The results and metrics are solid for all estimators, with the "EBITDA in US$ million" being estimated in the US$191-233 million range.One surprising result is that the indicator "Net working capital in US$ million" has been found to have a negative relationship with the dependent variable "EBITDA in US$ million".

<p align="center">
  <img width="80%" height="100%" src="https://github.com/ebelingbarros/udacity_capstone_project/blob/main/synthesis.png"> 
</p> 
...
<p align="center">
  <img width="80%" height="100%" src="https://github.com/ebelingbarros/udacity_capstone_project/blob/main/synthesis2.png"> 
</p> 
